...
This `R6` class is intended to be used as a secret manager for SAIL DB authentication; it's primarily intended to be used internally by [SAILR::Connection](./Profile.Rmd) but it has been exported for use as it might be useful for your other projects.
