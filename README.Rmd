...
> [!IMPORTANT]  
> You won't be able to use this method whilst inside the gateway as Github is blocked for security; use the first method if you are developing inside the gateway  
...
Please see the [documentation](./man) and [vignettes](./vignettes) for detailed examples and explanations.
